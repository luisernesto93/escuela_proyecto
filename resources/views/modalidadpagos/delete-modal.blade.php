        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('modalidadpago-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="modalidadpago-delete-form" method="POST" action="{{ route('modalidadpagos.destroy', ['modalidadpago' => $modalidadpago->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
