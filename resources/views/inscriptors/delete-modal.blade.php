        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('inscriptor-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="inscriptor-delete-form" method="POST" action="{{ route('inscriptors.destroy', ['inscriptor' => $inscriptor->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
