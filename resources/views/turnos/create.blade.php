...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{route('turnos.index')}}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
    ...
    <div class="card shadow mb-4">
        ...
        <form method="POST" action="{{route('turnos.store')}}">
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-primary float-right mr-3 mb-3" href="{{ route('turnos.index') }}">CANCELAR</a>
            </div>
        </form>
    </div>
