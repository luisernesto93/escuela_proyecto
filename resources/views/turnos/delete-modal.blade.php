        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('turno-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="turno-delete-form" method="POST" action="{{ route('turnos.destroy', ['turno' => $turno->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
