        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('materias-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="materias-delete-form" method="POST" action="{{ route('materias.destroy', ['materia' => $materia->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
