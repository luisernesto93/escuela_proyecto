        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('localidade-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="localidade-delete-form" method="POST" action="{{ route('localidades.destroy', ['localidade' => $localidade->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
