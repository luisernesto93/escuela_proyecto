        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('inscripcion-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="inscripcion-delete-form" method="POST" action="{{ route('inscripciones.destroy', ['inscripcione' => $inscripcion->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
