        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('provincia-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="provincia-delete-form" method="POST" action="{{ route('provincias.destroy', ['provincia' => $provincia->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
