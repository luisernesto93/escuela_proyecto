...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="font-weight-bold text-primary"><i class="fas fa-user-plus"></i> REGISTRAR PROVINCIA</h6>
        </div>
        <form method="POST" action="{{route('provincias.store')}}">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-3 mb-3 mt-3">
                        <label for="departamento_id"><strong>Departamento:</strong>
                            <span style="color:red;">*</span></label>
                        <select class="form-control form-control-sm @error('departamento_id') is-invalid @enderror" name="departamento_id" id="departamento_id"
                        required>
