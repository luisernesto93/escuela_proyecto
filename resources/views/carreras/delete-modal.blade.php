        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('carrera-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="carrera-delete-form" method="POST" action="{{ route('carreras.destroy', ['carrera' => $carrera->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
