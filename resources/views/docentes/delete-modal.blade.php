        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('docente-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="docente-delete-form" method="POST" action="{{ route('docentes.destroy', ['docente' => $docente->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
