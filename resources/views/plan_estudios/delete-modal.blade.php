        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('plan_estudios-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="plan_estudios-delete-form" method="POST" action="{{ route('plan_estudios.destroy', ['plan_estudio' => $plan_estudio->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
