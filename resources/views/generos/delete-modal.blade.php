        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('genero-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="genero-delete-form" method="POST" action="{{ route('generos.destroy', ['genero' => $genero->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
