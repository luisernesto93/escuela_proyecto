        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('departamento-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="departamento-delete-form" method="POST" action="{{ route('departamentos.destroy', ['departamento' => $departamento->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
