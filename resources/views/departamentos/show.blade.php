...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="font-weight-bold text-primary"><i class="fas fa-user-plus"></i> DETALLE DEPARTAMENTO</h6>
        </div>
        {{-- <form method="POST" action="{{route('departamentos.update', ['departamento' => $departamento->id])}}">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    {{-- <div class="col-sm-3 mb-3 mt-3">
                        <strong>Pa&iacute;s:<span style="color:red;">*</span></strong>
                        <select class="form-control form-control-sm @error('pais_id') is-invalid @enderror" name="pais_id" disabled>
                    ...
                    <div class="col-sm-3 mb-3 mt-3">
                        <strong>Pa&iacute;s:</strong> <span style="color:red;">*</span>
                        <input
                            type="text"
                            class="form-control form-control-sm @error('pais_id') is-invalid @enderror"
                            id="pais_id"
                            placeholder="Pa&iacute;s"
                            name="pais_id"
                            @if ($departamento->pais)
                            value="{{ old('pais_id', $departamento->pais->nombre ?? '') }}"
                            @endif
                            disabled>
                    </div>
            ...
            <a class="btn btn-outline-success float-right mr-3 mb-3" href="{{ route('departamentos.index') }}"><i class="fas fa-window-close"></i> ATR&Aacute;S</a>
            </div>
        </form>
    </div>
