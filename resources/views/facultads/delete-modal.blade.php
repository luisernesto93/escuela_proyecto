        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('facultad-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="facultad-delete-form" method="POST" action="{{ route('facultads.destroy', ['facultad' => $facultad->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
