        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('gestion-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="gestion-delete-form" method="POST" action="{{ route('gestions.destroy', ['gestion' => $gestion->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
