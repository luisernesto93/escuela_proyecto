        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('libros-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="libros-delete-form" method="POST" action="{{ route('libros.destroy', ['libro' => $libro->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
