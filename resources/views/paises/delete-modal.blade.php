        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('pais-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="pais-delete-form" method="POST" action="{{ route('paises.destroy', ['paise' => $pais->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
