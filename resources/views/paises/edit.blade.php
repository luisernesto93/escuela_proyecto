...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="font-weight-bold text-primary"><i class="fas fa-user-plus"></i> ACTUALIZAR PAIS</h6>
        </div>
        <form method="POST" action="{{route('paises.update', ['paise' => $paise->id])}}">
            ...
            <div class="card-footer">
                ...
                <a class="btn btn-outline-primary float-right mr-3 mb-3" href="{{ route('paises.index') }}"><i class="fas fa-arrow-left fa-sm text-primary-100"></i> CANCELAR</a>
            </div>
        </form>
    </div>
