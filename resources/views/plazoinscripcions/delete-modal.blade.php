        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('plazoinscripcion-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="plazoinscripcion-delete-form" method="POST" action="{{ route('plazoinscripcions.destroy', ['plazoinscripcion' => $plazoinscripcion->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
