        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('canal_publicitario-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="canal_publicitario-delete-form" method="POST" action="{{ route('canal_publicitarios.destroy', ['canal_publicitario' => $canal_publicitario->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
