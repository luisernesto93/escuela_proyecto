...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="font-weight-bold text-primary"><i class="fas fa-user-show"></i> DETALLE CANAL PUBLICITARIO</h6>
        </div>
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-sm-2 mb-3 mt-3">
                        ...
                        <input type="text"
                            ...
                            placeholder="id"
                            name="id"
                            value="{{ old('id', $canal_publicitario->id) }}"
                            disabled>
                        </input>
                        @error('id')
            ...
            <div class="card-footer">
                <a class="btn btn-outline-success float-right mr-3 mb-3" href="{{ route('canal_publicitarios.index') }}"><i class="fas fa-window-close"></i> ATR&Aacute;S</a>
            </div>
    </div>
