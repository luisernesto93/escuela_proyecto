        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-outline-danger" href="{{ route('logout') }}"
                    onclick="event.preventDefault(); document.getElementById('resoluciones-delete-form').submit();">
                    <i class="fas fa-trash"></i>
                    ELIMINAR
                </a>
                <form id="resoluciones-delete-form" method="POST" action="{{ route('resoluciones.destroy', ['resolucione' => $resolucion->id]) }}">
                    @csrf
                    @method('DELETE')
                </form>
            </div>
